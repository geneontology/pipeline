pipeline {
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/ontology/extensions/go-amigo.owl"
	].join(" ")
	GOLR_INPUT_GAFS = [
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/products/upstream_and_raw_data/paint_other.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/annotations/goa_chicken.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/annotations/goa_chicken_complex.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/annotations/goa_uniprot_all_noiea.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/annotations/mgi.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/annotations/pombase.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/annotations/wb.gaf.gz"
	].join(" ")
	GOLR_INPUT_PANTHER_TREES = [
	    "http://skyhook.berkeleybop.org/go-site-2063-check-valid-id-in-dbxref/products/panther/arbre.tgz"
	].join(" ")
