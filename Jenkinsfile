pipeline {
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/issue-amigo-620-change-default-closure/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-amigo-620-change-default-closure/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-amigo-620-change-default-closure/ontology/extensions/go-gaf.owl",
	    "http://skyhook.berkeleybop.org/issue-amigo-620-change-default-closure/ontology/extensions/gorel.owl",
	    "http://skyhook.berkeleybop.org/issue-amigo-620-change-default-closure/ontology/extensions/go-modules-annotations.owl",
	    "http://skyhook.berkeleybop.org/issue-amigo-620-change-default-closure/ontology/extensions/go-taxon-subsets.owl",
	...
	stage('Produce derivatives') {
	    agent {
		docker {
		    image 'geneontology/golr-autoindex:1f6cc855cb3b031507148a65d2fddbd2e6881c2f_2021-10-05T175722_issue-620-change-default-closure'
		    // Reset Jenkins Docker agent default to original
		    // root.
