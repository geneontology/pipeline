pipeline {
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/ontology/extensions/go-gaf.owl",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/ontology/extensions/gorel.owl",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/ontology/extensions/go-modules-annotations.owl",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/ontology/extensions/go-taxon-subsets.owl",
	...
	GOLR_INPUT_GAFS = [
	    //"http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/products/annotations/paint_other.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/annotations/aspgd.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/annotations/goa_chicken.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/annotations/goa_chicken_complex.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/annotations/goa_uniprot_all_noiea.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/annotations/mgi.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/annotations/pombase.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/annotations/wb.gaf.gz"
	].join(" ")
	GOLR_INPUT_PANTHER_TREES = [
	    "http://skyhook.berkeleybop.org/issue-183-code-too-large-retry/products/panther/arbre.tgz"
	].join(" ")
