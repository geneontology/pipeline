pipeline {
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/issue-248-go-ontology-size/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/ontology/extensions/go-gaf.owl",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/ontology/extensions/gorel.owl",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/ontology/extensions/go-modules-annotations.owl",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/ontology/extensions/go-taxon-subsets.owl",
	...
	GOLR_INPUT_GAFS = [
	    //"http://skyhook.berkeleybop.org/issue-248-go-ontology-size/products/annotations/paint_other.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/annotations/aspgd.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/annotations/goa_chicken.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/annotations/goa_chicken_complex.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/annotations/goa_uniprot_all_noiea.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/annotations/mgi.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/annotations/pombase.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/annotations/wb.gaf.gz"
	].join(" ")
	GOLR_INPUT_PANTHER_TREES = [
	    "http://skyhook.berkeleybop.org/issue-248-go-ontology-size/products/panther/arbre.tgz"
	].join(" ")
	...
	stage('Produce ontology') {
		...
		dir('./go-ontology') {
		    ...
		    checkout changelog: false, poll: false, scm: [$class: 'GitSCM', branches: [[name: TARGET_GO_ONTOLOGY_BRANCH]], extensions: [[$class: 'CloneOption', depth: 1, noTags: true, reference: '', shallow: true, timeout: 120]], userRemoteConfigs: [[url: 'https://github.com/geneontology/go-ontology.git', refspec: '+refs/heads/master:refs/remotes/origin/master']]]
		    // Default namespace.
		    sh 'date'
		    sh 'env'
		    sh 'ls -AlF'
