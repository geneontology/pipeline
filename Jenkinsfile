pipeline {
	...
	TARGET_GO_SITE_BRANCH = 'issue-pipeline-354-sgd-test-pipeline'
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/ontology/extensions/go-amigo.owl"
	].join(" ")
	GOLR_INPUT_GAFS = [
	    //"http://skyhook.berkeleybop.org/master/products/upstream_and_raw_data/paint_other.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/annotations/goa_chicken.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/annotations/goa_chicken_complex.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/annotations/goa_uniprot_all_noiea.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/annotations/mgi.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/annotations/sgd.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/annotations/pombase.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/annotations/wb.gaf.gz"
	].join(" ")
	GOLR_INPUT_PANTHER_TREES = [
	    "http://skyhook.berkeleybop.org/issue-354-sgd-test-pipeline/products/panther/arbre.tgz"
	].join(" ")
