pipeline {
	...
	TARGET_GO_SITE_BRANCH = 'issue-2210-fix-panther-id-syntax'
	...
	// "separated" string.
	TARGET_ADMIN_EMAILS = 'sjcarbon@lbl.gov,debert@usc.edu,smoxon@lbl.gov,muruganu@usc.edu'
	TARGET_SUCCESS_EMAILS = 'sjcarbon@lbl.gov,debert@usc.edu,suzia@stanford.edu,smoxon@lbl.gov,muruganu@usc.edu'
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_GAFS = [
	    ...
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/goa_chicken.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/goa_chicken_complex.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/goa_uniprot_all_noiea.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/mgi.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/pombase.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/wb.gaf.gz",
		"http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/pseudocap.gaf.gz",
		"http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/goa_pig_rna.gaf.gz",
		"http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/goa_pig_complex.gaf.gz",		
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/annotations/goa_pig.gaf.gz"
	].join(" ")
	GOLR_INPUT_PANTHER_TREES = [
	    "http://skyhook.berkeleybop.org/go-site-2210-gorule-0000027-id-syntax/products/panther/arbre.tgz"
	].join(" ")
	...
	stage('Archive (*)') {
		...
		withCredentials([file(credentialsId: 'skyhook-private-key', variable: 'SKYHOOK_IDENTITY')]) {
		    ...
		    sh 'mv $WORKSPACE/mnt/$BRANCH_NAME/annotations/goa_uniprot_all.gaf.gz $WORKSPACE/mnt/$BRANCH_NAME/annotations/filtered_goa_uniprot_all.gaf.gz || true'
		    sh 'mv $WORKSPACE/mnt/$BRANCH_NAME/annotations/goa_uniprot_all_noiea.gaf.gz $WORKSPACE/mnt/$BRANCH_NAME/annotations/filtered_goa_uniprot_all_noiea.gaf.gz || true'
		    sh 'mv $WORKSPACE/mnt/$BRANCH_NAME/annotations/goa_uniprot_all_noiea.gpad.gz $WORKSPACE/mnt/$BRANCH_NAME/annotations/filtered_goa_uniprot_all_noiea.gpad.gz || true'
		    sh 'mv $WORKSPACE/mnt/$BRANCH_NAME/annotations/goa_uniprot_all_noiea.gpi.gz $WORKSPACE/mnt/$BRANCH_NAME/annotations/filtered_goa_uniprot_all_noiea.gpi.gz || true'
		    ...
		    sh 'mv README-annotation-downloads.txt $WORKSPACE/mnt/$BRANCH_NAME/annotations/README.txt || true'
		    ...
		    sh 'rm -r -f $WORKSPACE/mnt/$BRANCH_NAME/bin || true'
		    sh 'rm -r -f $WORKSPACE/mnt/$BRANCH_NAME/lib || true'
		    sh 'ls -AlF $WORKSPACE/mnt/$BRANCH_NAME/'
		}
