pipeline {
	...
	stage('Produce ontology') {
		...
		dir('./go-ontology') {
			...
			sh 'scp -o StrictHostKeyChecking=no -o IdentitiesOnly=true -o IdentityFile=$SKYHOOK_IDENTITY -r src/ontology/target/* skyhook@skyhook.berkeleybop.org:/home/skyhook/$BRANCH_NAME/ontology/'
		    }
