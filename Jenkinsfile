pipeline {
	...
	TARGET_GO_SITE_BRANCH = 'issue-pipeline-237-mgi-test-pipeline'
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/ontology/extensions/go-gaf.owl",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/ontology/extensions/gorel.owl",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/ontology/extensions/go-modules-annotations.owl",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/ontology/extensions/go-taxon-subsets.owl",
	...
	GOLR_INPUT_GAFS = [
	    //"http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/products/annotations/paint_other.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/annotations/aspgd.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/annotations/goa_chicken.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/annotations/goa_chicken_complex.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/annotations/goa_uniprot_all_noiea.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/annotations/mgi.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/annotations/pombase.gaf.gz",
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/annotations/wb.gaf.gz"
	].join(" ")
	GOLR_INPUT_PANTHER_TREES = [
	    "http://skyhook.berkeleybop.org/issue-237-mgi-test-pipeline/products/panther/arbre.tgz"
	].join(" ")
