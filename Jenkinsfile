pipeline {
	...
	TARGET_GO_SITE_BRANCH = 'issue-2392-gorule-0000065-implement-rule'
	...
	/// Ontobio Validation
	///
	VALIDATION_ONTOLOGY_URL="http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/ontology/go.json"
	...
	MINERVA_INPUT_ONTOLOGIES = [
	    "http://skyhook.berkeleybop.org//go-site-2392-gorule-0000065-implement-rule/ontology/extensions/go-lego.owl"
	].join(" ")
	...
	GOLR_INPUT_GAFS = [
	    ...
	    "http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/annotations/goa_chicken.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/annotations/goa_chicken_complex.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/annotations/goa_uniprot_all_noiea.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/annotations/mgi.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/annotations/pombase.gaf.gz",
	    "http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/annotations/wb.gaf.gz"
	].join(" ")
	GOLR_INPUT_PANTHER_TREES = [
	    "http://skyhook.berkeleybop.org/go-site-2392-gorule-0000065-implement-rule/products/panther/arbre.tgz"
	].join(" ")
