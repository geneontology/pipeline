...
This is a standing pipeline in development that will be used to process GO Central as an "upstream for consumption by other (possibly external) pipelines. See: https://github.com/geneontology/project-management/issues/93 .
